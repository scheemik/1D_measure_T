...
if sbp.plot_amplitude:
    ...
    hf.plot_z_vs_t(plt_tr_z, plt_tr_t, T, dn_amp, BP_tr, kL, theta, omega, z_I=z_I, z_T=z_T, z0_dis=z0_dis, zf_dis=zf_dis, plot_full_x=plt_f_x, plot_full_y=plt_f_y, T_cutoff=None, c_map='Reds', title_str=run_name+' AA', filename=filename_prefix+'_1D_AA.png')
